...
#filter to similar-sized lemurs
...
#density plots with facet wrap by species
...
#filled version of density plots with facet wrap by species
weights_plot <- similar_weights %>% ggplot(aes(x=weight, group=sex, fill=sex)) +
